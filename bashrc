# Set path
export PATH="/usr/local/go/bin:$HOME/.local/bin:$HOME/go/bin:$HOME/.cargo/bin:$HOME/.pdtm/go/bin:/snap/bin:$PATH"

# Variable to track if it's the first prompt
first_prompt=true

# Function to print a newline before the prompt, except the first one
my_preprompt_function() {
...
# Set PROMPT_COMMAND to execute the function before each prompt
PROMPT_COMMAND="my_preprompt_function;$PROMPT_COMMAND"
